...
|---|---|---|---|---|
| **F10** | absent | unverifiable (`submission:19/attachment-1`) | **unverifiable** | TNA Submission 19 Attachment 1 is not published on either the submissions or hearings page; it cannot be fetched, so the claim stays unverifiable — correctly. |
